...
## R3 Physics task decoder result

The FIT-only decoder audit was run in a clean detached server worktree at
`3c53bcd` and sealed to a new root:
`OFFICIAL_V3_PHYSICS_TASK_DECODER_V1_3c53bcd_20260719`.

- `status = PASS_TASK_CONDITIONAL_DECODER`
- FIT identities: `800`
- tasks checked: `40/40`
- task holds: `0`
- source assertions: collector object-state read, ordered LIBERO object
  concatenation, four sensors per object, world-pose disablement, and
  Robosuite modality-order concatenation all passed
- root `SHA256SUMS` SHA: `168afe0b1e68ed18d8b066e4a30e750e6495eb199f2ac51c9e308e9a5da86fd9`
- root sidecar SHA: `31e190fc88094288107e8dce3f5de4571a77fcb867c9e08538a3baa8ecf31a01`

This closes the task/object-state layout decoder only. It does not yet freeze
...
1. Future evaluator runs must retain strict checkpoint loading (`strict=True`).
