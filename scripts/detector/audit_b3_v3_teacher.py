...
def audit_root(materialized_root: Path, registry_rows: list[dict[str, str]], feature_order_sha256: str) -> dict[str, object]:
...
def main() -> int:
    ...
    report = audit_root(args.materialized_root.resolve(), registry_rows, contract["feature_order_sha256"])
