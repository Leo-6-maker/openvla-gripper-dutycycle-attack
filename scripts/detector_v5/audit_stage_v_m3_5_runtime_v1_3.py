...
def _audit_all(protocol_path: Path, authorization_path: Path, runtime_root: Path) -> tuple[dict[str, Any], list[dict[str, Any]]]:
    ...
    structural: list[str] = []
    if protocol.get("schema") != "STAGE_V_M3_5_DIAGNOSTIC_PROTOCOL_V1_3" or protocol.get("version") != "V1.3.4" or _sha_file(protocol_path) != authorization.get("protocol_sha256"):
