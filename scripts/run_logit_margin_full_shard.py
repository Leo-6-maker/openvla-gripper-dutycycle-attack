...
# Load candidates
with open(os.path.join(SHARED, 'candidate_csv')) as f:
...
# Write outputs
OUT_TRACE = os.path.join(REPO, 'tables/openvla_action_token_logit_trace_summary.csv')
OUT_WINDOW = os.path.join(REPO, 'tables/openvla_logit_margin_online_features.csv')
