...
class PlanController:
    ...
    def _ensure_r2b_spec(self, plans: Mapping[str, Any], *, q_reason: str) -> str:
        ...
        spec = {
            ...
            "resource_policy": {"resource_kind": "GPU", "required_gpu_count": 8, "minimum_gpu_count": 8, "maximum_gpu_count": 8, "strict_gpu_count": True, "excluded_gpus": [], "gpu5_authorized": True, "protected_pids": [int(self.args.external_pid)], "canary_peak_mib": 0, "allow_foreign_gpu_sharing": True},
