#!/bin/bash
# S20b GPU45 — tomato_sauce seed24 VIS + seed50 × clean/RAND/VIS (4 full episodes)
set +e
...
EPS=6; PGD=20; L=10; MAX=400; JOB=958200

# tomato_sauce seed24 × VIS
...
echo "[$(date +%H:%M:%S)] S20b GPU45 DONE"
