...
def run_seed_matrix(args: argparse.Namespace) -> dict[str, Any]:
    ...
    metrics_rows = [
        {
            ...
            "test_positive_event_no_emit_rate": r.get("test_metrics", {}).get("positive_event_no_emit_rate", ""),
            "test_negative_episode_false_emit_rate": r.get("test_metrics", {}).get("negative_episode_false_emit_rate", ""),
            "test_primary_positive_emit_recall": r.get("test_metrics", {}).get("primary_positive_emit_recall", ""),
            "test_supplementary_positive_emit_recall": r.get("test_metrics", {}).get("supplementary_positive_emit_recall", ""),
            "test_primary_positive_episode_count": r.get("test_metrics", {}).get("primary_positive_episode_count", ""),
            "test_supplementary_positive_episode_count": r.get("test_metrics", {}).get("supplementary_positive_episode_count", ""),
    ...
    report = {
        ...
        "planned_runs": 3 * len(args.m1_seeds) + 3 * len(args.m2_seeds),
