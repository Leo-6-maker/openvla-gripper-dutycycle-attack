#!/bin/bash
# S18 Overnight GPU10 — actual tasks 0-3: alphabet_soup, cream_cheese, salad_dressing, bbq_sauce
# 4 tasks × 5 windows × 2 conditions = 40 jobs, seed70
set +e
...
TASKS=("alphabet_soup" "cream_cheese" "salad_dressing" "bbq_sauce")
