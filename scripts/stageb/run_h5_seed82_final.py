#!/usr/bin/env python3
"""H5 seed81 formal closed-loop: CLEAN→TRUE→RAND→SHUFFLED on GPU(1,5).
...
CID_MAP = {82: {'TRUE': 8, 'RAND': 3, 'SHUFFLED': 13}}
EXPECTED = {
    ('TRUE', 8): {'token': 31744, 'min_arm': 5, 'label': 'OPEN'},
    ('RAND', 3): {'token': 31872, 'min_arm': 6, 'label': 'CLOSE'},
    ('SHUFFLED', 13): {'token': 31872, 'min_arm': 6, 'label': 'CLOSE'},
...
SEED = 82; ATTACK_STEP = 60; MAX_STEPS = 400
