...
TABLES = {
    "table1_end_to_end_attack_results_schema.csv": [
        ...
        "preregistered_parent", "clean_valid", "mechanism_eligible",
        "detector_emitted", "attacked", "official_SR", "CQFR", "CQSR",
        "success", "failure_taxonomy", "target_token_rate", "qpos_open_response",
        "arm_selectivity", "attack_frames", "attack_duty_cycle",
        "matched_random", "matched_fixed_or_heuristic", "control_matched",
        "claim_allowed",
    ],
    "table2_detector_localization_transfer_schema.csv": [
        "suite", "task_idx", "state_id", "clean_success", "mlp_emit",
        "mlp_emit_step", "mechanism_type", "teacher_valid",
        "teacher_anchor_step", "teacher_window_start", "teacher_window_end",
        "teacher_event_id", "window_hit", "emit_error", "early_trigger",
        "post_release_trigger", "correct_abstain", "timing_class",
    ...
    "table3_visual_open_qpos_failure_mechanism_schema.csv": [
        ...
        "env_gripper", "executed_OPEN_count", "executed_OPEN_streak",
        "qpos_delta", "qpos_onset_delay", "width_delta",
        "object_contact_proxy", "visible_detachment", "manual_audit_label",
        "manual_auditor_agreement", "CQ_failure", "task_outcome",
        "mechanism_claim_level",
    ],
    "table4_timing_payload_ablations_schema.csv": [
        "ablation", "suite", "parent", "seed", "trigger_policy", "payload",
        "uses_future", "uses_privileged_online", "attack_frames",
        "same_epsilon", "same_PGD_steps", "same_parent", "epsilon", "steps",
        "selected_window", "primary_metric", "control_metric", "pass_fail",
    ],
