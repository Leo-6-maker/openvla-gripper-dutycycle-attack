#!/bin/bash
# S20b GPU10 — ketchup seeds 74,75 × clean/RAND/VIS (6 full episodes)
set +e
...
T=ketchup; SID=0; WS=150; WE=160; EPS=6; PGD=20; L=10; MAX=400; JOB=958000

for SEED in 74 75; do
...
echo "[$(date +%H:%M:%S)] S20b GPU10 DONE"
