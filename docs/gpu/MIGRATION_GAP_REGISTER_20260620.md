...
```
M0_HOST_SAFETY                   = BLOCKED_BY_ROOT_FULL
M0_OWN_CACHE_CLEANUP             = COMPLETE (604 MiB freed, only 580 MB on root)
M1A_DEPENDENCY_INSTALL           = PASS
M1A_REPRODUCIBILITY_AUDIT        = PARTIAL
M1B_FLASH_ATTN                   = NO_GO
MIG1_MODEL_SYNC                  = NO_GO
MIG1_PREFLIGHT_REPAIR            = GO
MIG1_MNT_SDC_CAPACITY_AUDIT      = GO
