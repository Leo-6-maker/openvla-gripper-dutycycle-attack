...
| builder_command_contract | `python tools/multisuite_detector/build_clean2000_label_v2.py --source-manifest <path> --episode-census <path> --source-crosstab <path> --output-root <empty-new-dir> --synthetic --dry-run` |
