...
| Frozen feature artifact ingestion and Label V2 feature join | EXISTS_AND_REVIEWED_AFTER_C2_SYNTHETIC |
| Parent split tooling | EXISTS_AND_REVIEWED_AFTER_C2_SYNTHETIC |
| State-hash leakage validation | EXISTS_AND_REVIEWED_AFTER_C2_SYNTHETIC |
...
| Streaming feature extraction | EXISTS_AND_REVIEWED_AFTER_C2_SYNTHETIC | `tools/multisuite_detector/load_frozen_clean_features.py`; `detector_dataset_closure_v1.py` | `tests/multisuite_detector/test_detector_dataset_closure_v1.py` | C2 defines a strict synthetic frozen-feature artifact schema with exact 25D `SC5_FEATURES`, finite step features, feature schema SHA, artifact SHA, and required `initial_state_hash`. Real feature artifact source remains NOT_PERFORMED. |
...
| Detector normalization manifest | EXISTS_AND_REVIEWED_AFTER_C2_SYNTHETIC | `tools/multisuite_detector/build_detector_normalization_v1.py`; `validate_detector_dataset_manifest_v1.py` | `tests/multisuite_detector/test_detector_dataset_closure_v1.py` | C2 computes train-only normalization for a selected split/fold/population, rejects zero variance, binds dataset/split/feature SHAs, and validates those bindings synthetically. |
