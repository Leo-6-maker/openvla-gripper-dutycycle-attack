...
def validate_training_authorization(value: Mapping[str, Any]) -> None:
    required = (
        ...
        "normalization_bundle_sha256", "normalization_sha256",
        "fold_manifest_sha256", "runner_head", "runner_binding", "authorization_generation",
        "authorization_payload_sha256", "input_snapshots", "variant", "fold_id", "seed",
    )
    ...
    for name in (
        ...
        "training_protocol_sha256", "source_contract_sha256", "protocol_sha256", "feature_rebuilder_sha256",
        "normalization_bundle_sha256", "normalization_sha256",
        "fold_manifest_sha256", "authorization_payload_sha256",
    ):
    ...
    if value.get("variant") not in B3_VARIANTS or value.get("fold_id") not in range(4) or value.get("seed") not in (20260717, 20260718, 20260719):
    ...
    if generation.get("generator_worktree_clean") is not True or generation.get("generator_entrypoint") != "build_b3_v3_training_authorization.py":
